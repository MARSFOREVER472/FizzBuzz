...
- **_Y para terminar, te presentamos de una manera más avanzada de solucionar este problema de JavaScript, donde usaremos una combinación de operadores ternarios mediante un método'Truthy' y 'Falsy'._**
